...
STRINGS = {
    "ru": {
        ...
        "hide_premium_emoji": "Скрыть премиум-эмодзи",
        "hide_premium_emoji_sub": "Убирает платные эмодзи из клавиатуры эмодзи",
        "premium_emoji_settings_header": "Скрытие премиум-эмодзи",
        "hide_premium_emoji_packs": "Скрыть эмодзи-паки",
        "hide_premium_recent": "Скрыть из недавних",
        "hide_premium_search": "Скрыть в поиске",
        "hide_premium_suggestions": "Скрыть в подсказках",
        "hide_premium_reactions": "Скрыть эмодзи-реакции",
        "hide_premium_stickers": "Скрыть премиум-стикеры",
        "hide_premium_stickers_sub": "Убирает платные стикеры из панели выбора",
    ...
    "en": {
        ...
        "hide_premium_emoji_sub": "Removes paid emoji from the emoji keyboard",
        "premium_emoji_settings_header": "Hide Premium Emoji",
        "hide_premium_emoji_packs": "Hide Emoji Packs",
        "hide_premium_recent": "Hide from Recents",
        "hide_premium_search": "Hide in Search",
        "hide_premium_suggestions": "Hide in Suggestions",
        "hide_premium_reactions": "Hide Emoji Reactions",
        "hide_premium_stickers": "Hide Premium Stickers",
        "hide_premium_stickers_sub": "Removes paid stickers from the picker panel",
